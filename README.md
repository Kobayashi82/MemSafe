...
int main(void)
{
    ...
    // Al salir, todo se libera automáticamente:
    // - Con exit(): se llama a free((void *)-42) y close(-42)
    // - Con execve(): se liberan recursos antes de ejecutar
    
    exit(0);  // Se libera todo automáticamente
}
```
